...
# ----- GENERATE FIGURE 1 (ALTERNATE VERSION 2: JUST AZ POLYGON) -----
...
# Save as shown on Plots
rstudioapi::savePlotAsImage(file = "output/fig_1_attempt4.png", 
                            format = "png",
                            width = 786, 
                            height = 609)
...
# ----- GENERATE FIGURE 1 (ALTERNATE VERSION: GOOGLE MAP) -----
